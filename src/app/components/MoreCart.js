...
const Sidebar = () => {
  return (
    <div className="w-[275px] hidden md:block ml-[50px] mt-[50px] h-fit bg-white border px-4 py-4">
      {/* Profile Section */}
      <div className="flex items-center justify-center space-x-3 mb-6">
        <div className="">
          ...
          >
            <g clipPath="url(#clip0_18051_151035)">
              <path
      ...
      <nav className="space-y-1">
        ...
        <div className="space-y-1">
          <div className="py-2 px-3   rounded">ข้อมูลทั่วไป</div>
    ...
    <div className="flex">
      ...
      <div className="flex-1">
        <div className="max-w-4xl mx-auto p-4">
            ...
            <thead>
              ...
              <tbody>
                <tr className="text-[#737373] text-[14px] ">
                  <td className="py-2 pr-2 w-[50%]">
                    <input
                      type="text"
                      placeholder='A&B 16" Notebook Pro Late 2019 Space Gray'
                      className="w-full placeholder:text-[#232936] border rounded px-3 py-2"
                    />
                  </td>
                ...
                <tr className="text-[#737373] text-[14px] ">
                  <td className="py-2 pr-2 w-[45%]">
                    <input
                      type="text"
                      placeholder='1234567'
                      className="w-full border placeholder:text-[#232936] rounded px-3 py-2"
                    />
                  </td>
                  <td className="py-2 px-2 w-[40%]">
                    <div className="relative">
          ...
          {/* Add More Rows Link */}
          <div className="text-center mb-6 bg-[#F4F9FF] py-2">
            <button className="text-[#0067C7] ">Add more rows</button>
          </div>
          ...
          <div className="mb-8 md:flex justify-between">
            ...
            <textarea className=" w-[100%] md:w-[80%] border-[#DEE7EF] border rounded p-3 h-24" />
          </div>
          <div className="text-right   mt-2">
            <button className="border w-[100%] md:w-fit rounded-full px-16 border-[#213550] text-[#213550] py-2">
              Validate
            </button>
          </div>
          ...
          <div className="md:flex mt-[20px]">
            <div>
              ...
              <p className="text-sm text-gray-600 mb-2">
                Upload a Spreadsheet with two columns<br></br> (SKU, Quantity)
                to bulk order
              </p>
          ...
          <div className="text-right mt-2">
            <button className="border rounded-full w-[100%] md:w-fit px-16 border-[#213550] text-[#213550] py-2">
              Validate
            </button>
          </div>
        </div>
