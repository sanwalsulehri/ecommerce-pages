...
<path d="M1 0.500244L6 5.50024L11 0.500244" stroke="#737373" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <section>
          ...
          <p variant="outline" className="mt-2 text-blue-500 text-center w-full bg-[#F4F9FF] py-2 border-blue-500">
            เพิ่มแถวใหม่
          </p>
        </section>

        {/* Form Actions */}
        <div className="md:flex text-center justify-between  text-[#213550] pt-6 border-t ">
          <p variant="ghost" className=" border px-24 py-2 text-[#213550] cursor-pointer rounded-full border-[#213550] ">
            ยกเลิก
          </p>
          <p className="bg-[#213550] rounded-full px-20 md:mt-[0px] mt-[14px] cursor-pointer py-2 text-white">ส่งข้อมูล</p>
        </div>
      </form>
    </div>
    </>
